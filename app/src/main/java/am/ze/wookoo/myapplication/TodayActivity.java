...
public class TodayActivity extends AppCompatActivity {
    ...
    public boolean onKeyDown(int KeyCode, KeyEvent event){
        ...
        if(KeyCode == KeyEvent.KEYCODE_VOLUME_UP){
            Toast.makeText(TodayActivity.this,"5초후 알람이 울립니다." ,Toast.LENGTH_SHORT).show();
            new Handler().postDelayed(new Runnable() {
                ...
                public void run() {
                    ...
                    Intent my_intent = new Intent(TodayActivity.this,Alarm_Reciver.class);
                    ...
                    pendingIntent = PendingIntent.getBroadcast(TodayActivity.this, 0, my_intent,
